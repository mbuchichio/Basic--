...
- CLI `bppc` accepts `transpile <file.bpp>` and currently parses the module header, imports, constants, state machines, and command blocks (pass `--tokens` to dump lexer output for debugging).
